...
align_scans      = True
align_data_xrd   = True
save_data_xrd_interpolate = True
save_data_xrf_interpolate = True
...
#            su.save_bin_data_nanomax(processing_path, xrd_interp)
            ...
            data_dic = {"data":xrd_interp[:,xrd_map_crop:None,:,:],\
                        "command": command, "motor_positions":motor_positions,\
                        "scan_positions_x":scan_positions_x[0:xrd_map_crop],\
                        "scan_positions_z":scan_positions_z[0:xrd_map_crop]}
